...
## Oriented FAST and Steered BRIEF (ORB) — Milestone 5
...
| FAST Detection     | Parallel          | **4.3x** speedup (2.14ms -> 499µs, 512x512) |
| ORB Pipeline       | Parallel          | **3.8x** speedup (115.39ms -> 30.61ms, 512x512) |
